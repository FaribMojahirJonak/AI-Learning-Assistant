...
export default function SignUpForm() {
    ...
    return (_jsxs("form", { onSubmit: handleSignUp, className: "space-y-4 max-w-md mx-auto p-6 bg-white rounded-xl shadow-lg", children: [_jsx("input", { className: "input input-bordered w-full", value: email, onChange: e => setEmail(e.target.value), placeholder: "Email" }), _jsx("input", { className: "input input-bordered w-full", type: "password", value: password, onChange: e => setPassword(e.target.value), placeholder: "Password" }), _jsx("input", { className: "input input-bordered w-full", value: fullName, onChange: e => setFullName(e.target.value), placeholder: "Full Name" }), _jsx("button", { className: "btn btn-primary w-full", type: "submit", children: "Sign Up" }), error && _jsx("div", { className: "text-red-500", children: error }), success && _jsx("div", { className: "text-green-600", children: success })] }));
}
